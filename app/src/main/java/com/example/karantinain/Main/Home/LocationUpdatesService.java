...
public class LocationUpdatesService extends Service {
    ...
    private static final String PACKAGE_NAME = "com.example.karantinain.Main.Home";
    ...
    private static final long UPDATE_INTERVAL_IN_MILLISECONDS = 1000 * 60 * 15; //15 menit
    ...
    private Notification getNotification() {
        ...
        CharSequence text = LocationUtils.getLocationText(getApplicationContext(), mLocation);
...
//                        servicePendingIntent)
                .setContentText(text)
                .setContentTitle(LocationUtils.getLocationTitle(getApplicationContext()))
                .setOngoing(true)
